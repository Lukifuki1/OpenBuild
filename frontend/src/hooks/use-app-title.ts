...
const APP_TITLE_OSS = "OpenBuild";
const APP_TITLE_SAAS = "OpenBuild Cloud";

/**
 * Hook that returns the appropriate document title based on app_mode and current route.
 * - For conversation pages: "Conversation Title | OpenBuild" or "Conversation Title | OpenBuild Cloud"
 * - For other pages: "OpenBuild" or "OpenBuild Cloud"
 */
