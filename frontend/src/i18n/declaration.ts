...
export enum I18nKey {
  ...
  PHOTO_TAB$TITLE = "PHOTO_TAB$TITLE",
  PHOTO_TAB$PROMPT_LABEL = "PHOTO_TAB$PROMPT_LABEL",
  PHOTO_TAB$PROMPT_PLACEHOLDER = "PHOTO_TAB$PROMPT_PLACEHOLDER",
  PHOTO_TAB$RESOLUTION_LABEL = "PHOTO_TAB$RESOLUTION_LABEL",
  PHOTO_TAB$STYLE_LABEL = "PHOTO_TAB$STYLE_LABEL",
  PHOTO_TAB$GENERATING = "PHOTO_TAB$GENERATING",
  PHOTO_TAB$GENERATE = "PHOTO_TAB$GENERATE",
  PHOTO_TAB$DOWNLOAD = "PHOTO_TAB$DOWNLOAD",
  PHOTO_TAB$CLEAR = "PHOTO_TAB$CLEAR",
  PHOTO_TAB$PREVIEW = "PHOTO_TAB$PREVIEW",
  PHOTO_TAB$EMPTY_MESSAGE = "PHOTO_TAB$EMPTY_MESSAGE",
  PHOTO_TAB$ERROR_NO_PROMPT = "PHOTO_TAB$ERROR_NO_PROMPT",
  PHOTO_TAB$ERROR_GENERIC = "PHOTO_TAB$ERROR_GENERIC",
  PHOTO_TAB$ERROR_NO_BATCH = "PHOTO_TAB$ERROR_NO_BATCH",
  PHOTO_TAB$ERROR_BATCH_LIMIT = "PHOTO_TAB$ERROR_BATCH_LIMIT",
  PHOTO_TAB$STATUS_PENDING = "PHOTO_TAB$STATUS_PENDING",
  PHOTO_TAB$STATUS_GENERATING = "PHOTO_TAB$STATUS_GENERATING",
  PHOTO_TAB$GENERATE_ANOTHER = "PHOTO_TAB$GENERATE_ANOTHER",
  PHOTO_TAB$PATH_LABEL = "PHOTO_TAB$PATH_LABEL",
  PHOTO_TAB$IMAGE_ID = "PHOTO_TAB$IMAGE_ID",
  VIDEO_TAB$TITLE = "VIDEO_TAB$TITLE",
  VIDEO_TAB$PROMPT_LABEL = "VIDEO_TAB$PROMPT_LABEL",
  VIDEO_TAB$PROMPT_PLACEHOLDER = "VIDEO_TAB$PROMPT_PLACEHOLDER",
  VIDEO_TAB$DURATION_LABEL = "VIDEO_TAB$DURATION_LABEL",
  VIDEO_TAB$FPS_LABEL = "VIDEO_TAB$FPS_LABEL",
  VIDEO_TAB$DURATION_DISPLAY = "VIDEO_TAB$DURATION_DISPLAY",
  VIDEO_TAB$PATH_LABEL = "VIDEO_TAB$PATH_LABEL",
  VIDEO_TAB$METADATA_DISPLAY = "VIDEO_TAB$METADATA_DISPLAY",
  VIDEO_TAB$RESOLUTION_LABEL = "VIDEO_TAB$RESOLUTION_LABEL",
  VIDEO_TAB$GENERATING = "VIDEO_TAB$GENERATING",
  VIDEO_TAB$GENERATE = "VIDEO_TAB$GENERATE",
  VIDEO_TAB$DOWNLOAD = "VIDEO_TAB$DOWNLOAD",
  VIDEO_TAB$CLEAR = "VIDEO_TAB$CLEAR",
  VIDEO_TAB$PREVIEW = "VIDEO_TAB$PREVIEW",
  VIDEO_TAB$EMPTY_MESSAGE = "VIDEO_TAB$EMPTY_MESSAGE",
  VIDEO_TAB$EMPTY_NOTE = "VIDEO_TAB$EMPTY_NOTE",
  VIDEO_TAB$ERROR_NO_PROMPT = "VIDEO_TAB$ERROR_NO_PROMPT",
  VIDEO_TAB$ERROR_GENERIC = "VIDEO_TAB$ERROR_GENERIC",
  VIDEO_TAB$STATUS_PENDING = "VIDEO_TAB$STATUS_PENDING",
  VIDEO_TAB$STATUS_GENERATING = "VIDEO_TAB$STATUS_GENERATING",
  VIDEO_TAB$GENERATE_ANOTHER = "VIDEO_TAB$GENERATE_ANOTHER",
  VIDEO_TAB$METADATA_TITLE = "VIDEO_TAB$METADATA_TITLE",
  VIDEO_TAB$MODEL_LABEL = "VIDEO_TAB$MODEL_LABEL",
  VIDEO_TAB$DOWNLOAD_VIDEO = "VIDEO_TAB$DOWNLOAD_VIDEO",
  VIDEO_TAB$VIDEO_ID = "VIDEO_TAB$VIDEO_ID",
  VIDEO_TAB$DURATION_UNIT = "VIDEO_TAB$DURATION_UNIT",
  VIDEO_TAB$FPS_UNIT = "VIDEO_TAB$FPS_UNIT",
  HOME$BUILD_DESCRIPTION = "HOME$BUILD_DESCRIPTION",
  BRANDING$BUILD = "BRANDING$BUILD",
  BRANDING$BUILD_LOGO = "BRANDING$BUILD_LOGO",
}
